...
case 12:
    if (["faccio riparare l’auto perché ne ho bisogno, poi andrò all’assicurazione espiegherò tutto"].includes(userChoice)) {
        group = 'A';
    ...
    break;
                                                    ...
                                                    case 13:
                                                        ...
                                                        case 14:
                                                            ...
                                                            case 15:
                                                                if (["Mi affido a prestiti bancari o finanziamenti per coprire il costo dell'acquisto"].includes(userChoice)) {
                                                                    group = 'A';
